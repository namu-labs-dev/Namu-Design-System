...
describe('Watermark', () => {
  ...
  it('The watermark should render successfully', () => {
    const { container } = render(<Watermark className="watermark" content="Namu Design" />);
  ...
  it('The offset should be correct', () => {
    const { container } = render(
      <Watermark
        className="watermark"
        offset={[200, 200]}
        content={['Namu Design', 'Namu Design Pro']}
      />,
    );
  ...
  it('Invalid image watermark', () => {
    ...
    const { container } = render(
      <Watermark className="watermark" content="Namu Design" image="https://test.svg" />,
    );
    expect(container.querySelector('.watermark div')).toBeTruthy();
    expect(container).toMatchSnapshot();
  });
