...
const locales = {
  cn: {
    title: 'Namu Design - 一套企业级 UI 设计语言和 React 组件库',
    description: '基于 Namu Design 设计体系的 React UI 组件库，用于研发企业级中后台产品。',
  },
  en: {
    title: "Namu Design - The world's second most popular React UI framework",
    description:
