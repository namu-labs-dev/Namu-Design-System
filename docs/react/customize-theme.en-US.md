...
Namu Design allows you to customize our design tokens to satisfy UI diversity from business or brand requirements, including primary color, border radius, border color, etc.
...
Themes with different styles can be quickly generated by modifying `algorithm`. Namu Design 5.0 provides three sets of preset algorithms by default:
